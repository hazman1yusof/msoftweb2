	...
	class cdreg_save{
		...
		public function edit_table($commit){
			...
			try{
				...
				//1st step add cbtran -
					$prepare = "INSERT INTO finance.cbtran (compcode,bankcode,source,trantype,auditno,postdate,year,period,amount,remarks,lastuser,lastupdate,bitype,reference,stat,refsrc,reftrantype,refauditno) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,NOW(),?,?,?,?,?,?)";
